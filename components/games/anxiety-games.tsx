...
import PebbleBalance from "./PebbleBalance";
...
const games = [
  ...
  },
  {
    ...
    description: "Click gentle bubbles to reveal tiny affirmations and soft chimes.",
    icon: Flower2,
    color: "text-sky-500",
  ...
  },
  {
    id: "maze",
    title: "Mindful Maze",
    description: "Guide a glowing orb along a slow path to the center — arrow keys or drag.",
    icon: Gamepad2, // or choose another icon import
  ...
  },
  {
    ...
    description: "Arrange pebbles in perfect balance — drag and drop to find the right position.",
    icon: Gamepad2,
