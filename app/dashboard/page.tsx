...
export default function Dashboard() {
  ...
  // compute friendly date string for header
  const headerDateString = currentTime.toLocaleDateString("en-US", {
    weekday: "long",
    month: "long",
    day: "numeric",
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      <Container className="pt-12 pb-8">
        ...
        <div className="w-full max-w-3xl text-center">
            ...
            >
              ...
              <motion.div
                ...
                animate={{ width: "88px", opacity: 1 }}
                transition={{ duration: 0.6, delay: 0.55, ease: "easeInOut" }}
                className="h-[3px] mx-auto mt-4 rounded-full bg-gradient-to-r from-primary to-primary/70"
              />

              {/* Date slides down from underline */}
              <motion.p
        ...
        {/* Small top-right controls (bell) kept but moved visually below header */}
        ...
        {/* Main Layout (re-ordered placement only) */}
        <div className="space-y-8 mt-6">
          ...
          {/* Row 2: Two-column grid - Today's Overview (left) and Insights (right) */}
          ...
          {/* Row 3: Anxiety Games (full width) */}
          <div>
            <Card className="border-primary/10">
              <CardContent>
